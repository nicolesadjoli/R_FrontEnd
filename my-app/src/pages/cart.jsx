...
import { delCart, saveCart, checkout, delQty } from '../redux/action'
            ...
            <>
                <div style={{ padding: '1%', minHeight: '100vh' }}>
                    ...
                    <Modal show={askPass} onHide={() => this.setState({ askPass: false })}>
                        <Modal.Header closeButton>
                            <Modal.Title>Are you sure to process this action?</Modal.Title>
                        </Modal.Header>
                        {/* <Modal.Body>
                            <FormControl
...
export default connect(mapStateToProps, { delCart, saveCart, checkout,delQty })(CartPage)
